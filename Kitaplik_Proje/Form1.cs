...
namespace Kitaplik_Proje
{
    public partial class Form1 : Form
    {
        ...
        OleDbConnection baglanti = new OleDbConnection(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\LENOVO\OneDrive\Masaüstü\Kitaplik.mdb");
        ...
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Close();
            MessageBox.Show("Kayıt listeden silindi.", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            listele();
        }
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            komut.Parameters.AddWithValue("@p", TxtKitapid.Text);
            komut.ExecuteNonQuery();
            baglanti.Close();
